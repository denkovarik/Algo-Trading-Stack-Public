...
from classes.wavelets.wavelets import (
    add_daubechies_wavelets, add_morlet_cwt,
    add_haar_denoising, add_mexican_hat, add_symlet_wavelets
)
from classes.indicators.fft import add_fft_full
